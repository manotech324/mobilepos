					...
					<ul>
						...
						<li class="submenu-open">
							...
							<ul>
								...
								<li class="{{ request()->routeIs('low.stocks') ? 'active' : '' }}">
								...
								<li class="{{ request()->routeIs('barcode') ? 'active' : '' }}">
									<a href=""><i class="ti ti-barcode fs-16 me-2"></i><span>Print Barcode</span></a>
								</li>
								<li class="{{ request()->routeIs('qrcode') ? 'active' : '' }}">
									<a href=""><i class="ti ti-qrcode fs-16 me-2"></i><span>Print QR Code</span></a>
								</li>
							</ul>
						</li>
						<li class="submenu-open">
