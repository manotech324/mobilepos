            ...
            <ul>
                <li class="submenu-open">
                    ...
                    <ul>
                        ...
                        <li class="submenu">
                            <a href="javascript:void(0);"><i class="ti ti-user-edit fs-16 me-2"></i><span>Super
                ...
                <li class="submenu-open">
                    ...
                    <ul>
                        ...
                        <li><a href="low-stocks.html"><i class="ti ti-trending-up-2 fs-16 me-2"></i><span>Low
                                    Stocks</span></a></li>
                        <li><a href="{{route("product-category.index")}}"><i
                        ...
                        <li><a href="units.html"><i class="ti ti-brand-unity fs-16 me-2"></i><span>Units</span></a>
                        </li>
                ...
                <li class="submenu-open">
                    ...
                    <ul>
                        ...
                        <li class="active"><a href="suppliers.html"><i
                ...
                <li class="submenu-open">
                    ...
                    <ul>
                        ...
                        <li><a href="javascript:void(0);"><i class="ti ti-exchange fs-16 me-2"></i><span>Changelog
                                </span><span class="badge bg-primary badge-xs text-white fs-10 ms-2">v2.0.9</span></a>
                        </li>
                        <li class="submenu">
...
<div class="sidebar sidebar-horizontal" id="horizontal-menu">
    <div id="sidebar-menu-3" class="sidebar-menu">
        <div class="main-menu">
            <ul class="nav-menu">
                <li class="submenu">
                    <a href="{{route('dashboard')}}"><i class="ti ti-layout-grid fs-16 me-2"></i><span> Main Menu</span>
                        ...
                        <li class="submenu">
                            ...
                            <ul>
                                ...
                                <li class="submenu submenu-two"><a href="javascript:void(0);"
                                        class="subdrop active">Ecommerce<span
                                            class="menu-arrow inside-submenu"></span></a>
                                    <ul>
                                        <li><a href="products.html">Products</a></li>
                                        <li><a href="orders.html">Orders</a></li>
                ...
                <li class="submenu">
                    ...
                    <ul>
                        <li class="submenu">
                            <a href="javascript:void(0);" class="active"><span>People</span><span
                                    class="menu-arrow"></span></a>
                            <ul>
        ...
        <div class="twocol-mini">
            <div class="sidebar-left slimscroll">
                <div class="nav flex-column align-items-center nav-pills" id="sidebar-tabs" role="tablist"
                    ...
                    <a href="#" class="nav-link active" title="Finance" data-bs-toggle="tab"
