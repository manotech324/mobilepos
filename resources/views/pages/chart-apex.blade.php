...
<!-- Mirrored from dreamspos.dreamstechnologies.com/html/template/chart-apex.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 May 2025 05:50:22 GMT -->
<head>
        ...
        <script src="assets/js/theme-script.js" type="621d2b44b4673643396d6a1c-text/javascript"></script>
    ...
    <body>
        ...
        <!-- jQuery -->
        <script src="assets/js/jquery-3.7.1.min.js" type="621d2b44b4673643396d6a1c-text/javascript"></script>

        <!-- Feather Icon JS -->
        <script src="assets/js/feather.min.js" type="621d2b44b4673643396d6a1c-text/javascript"></script>

        <!-- Slimscroll JS -->
        <script src="assets/js/jquery.slimscroll.min.js" type="621d2b44b4673643396d6a1c-text/javascript"></script>

        <!-- Bootstrap Core JS -->
        <script src="assets/js/bootstrap.bundle.min.js" type="621d2b44b4673643396d6a1c-text/javascript"></script>

        <!-- Chart JS -->
        <script src="assets/plugins/apexchart/apexcharts.min.js" type="621d2b44b4673643396d6a1c-text/javascript"></script>
        <script src="assets/plugins/apexchart/chart-data.js" type="621d2b44b4673643396d6a1c-text/javascript"></script>
        
        <!-- Color Picker JS -->
		<script src="assets/plugins/%40simonwep/pickr/pickr.es5.min.js" type="621d2b44b4673643396d6a1c-text/javascript"></script>

		<!-- Custom JS -->
		<script src="assets/js/theme-colorpicker.js" type="621d2b44b4673643396d6a1c-text/javascript"></script>
		<script src="assets/js/script.js" type="621d2b44b4673643396d6a1c-text/javascript"></script>
		
    <script src="../../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="621d2b44b4673643396d6a1c-|49" defer></script><script defer src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015" integrity="sha512-ZpsOmlRQV6y907TI0dKBHq9Md29nnaEIPlkf84rnaERnq6zvWvPUqr2ft8M1aS28oN72PdrCzSjY4U6VaAw1EQ==" data-cf-beacon='{"rayId":"93f78bd3de4ad059","version":"2025.4.0-1-g37f21b1","serverTiming":{"name":{"cfExtPri":true,"cfL4":true,"cfSpeedBrain":true,"cfCacheStatus":true}},"token":"3ca157e612a14eccbb30cf6db6691c29","b":1}' crossorigin="anonymous"></script>
</body>
