...
<!-- Mirrored from dreamspos.dreamstechnologies.com/html/template/all-blog.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 May 2025 05:46:09 GMT -->
<head>
		...
		<script src="assets/js/theme-script.js" type="d71f021ab323125ad8bb097b-text/javascript"></script>
    ...
    <body>
					...
					<ul>
						...
						<li class="submenu-open">
							...
							<ul>
								...
								<li class="submenu">
									<a href="javascript:void(0);" class="active subdrop"><i class="ti ti-wallpaper fs-16 me-2"></i><span>Blog</span><span class="menu-arrow"></span></a>
									<ul>
										<li><a href="all-blog.html" class="active">All Blog</a></li>
			...
			<div id="sidebar-menu-3" class="sidebar-menu">
				<div class="main-menu">
					<ul class="nav-menu">
						...
						<li class="submenu">
							<a href="javascript:void(0);" class="active subdrop"><i class="ti ti-page-break fs-16 me-2"></i><span>Pages</span> <span class="menu-arrow"></span></a>
							<ul>
								...
								<li class="submenu">
									<a href="javascript:void(0);" class="active"><span>Content</span><span class="menu-arrow"></span></a>
									<ul>
										<li class="submenu">
										...
										<li class="submenu">
											<a href="javascript:void(0);" class="active"><span>Blog</span><span class="menu-arrow"></span></a>
											<ul>
												<li><a href="all-blog.html" class="active">All Blog</a></li>
												<li><a href="blog-tag.html">Blog Tags</a></li>
												<li><a href="blog-categories.html">Categories</a></li>
				...
				<div class="twocol-mini">
					<div class="sidebar-left slimscroll">
						<div class="nav flex-column align-items-center nav-pills" id="sidebar-tabs" role="tablist"
							...
							<a href="#" class="nav-link active" title="Pages" data-bs-toggle="tab" data-bs-target="#pages">
					...
					<div class="row justify-content-center">
							...
							<div class="card">
								<div class="card-body">
									<div class="img-sec w-100 position-relative mb-3">
										<a href="blog-details.html"><img src="assets/img/blogs/blog-01.jpg" class="img-fluid rounded w-100" alt="img"></a>
										<div>
											<a href="blog-details.html" class="trend-tag badge bg-soft-info shadow-none fs-10 fw-medium">Features</a>
									...
									<div class="d-flex align-items-center justify-content-between mb-3">
										<div class="d-flex align-items-center">
											...
											<a href="javascript:void(0);" class="border-start link-default fs-14 fw-normal ps-2 me-2 text-truncate d-inline-flex align-items-center d-inline-flex align-items-center"><img src="assets/img/users/user-02.jpg" class="avatar avatar-xs rounded-circle me-2 flex-shrink-0" alt="Img">Gertrude Bowie</a>
										</div>
										<div class="d-flex align-items-center">
									...
									<h5>
										<a href="blog-details.html" class="fs-16 text-truncate">What is a POS System? A Beginner’s Guide</a>
									</h5>
								</div>
							</div>
						</div>
						<div class="col-xxl-4 col-md-6">
							<div class="card">
								<div class="card-body">
									<div class="img-sec w-100 position-relative mb-3">
										<a href="blog-details.html"><img src="assets/img/blogs/blog-02.jpg" class="img-fluid rounded w-100" alt="img"></a>
										<div>
											<a href="blog-details.html" class="trend-tag badge bg-soft-info shadow-none">Business</a>
											<span class="badge badge-success dot-icon"><i class="ti ti-point-filled"></i> Active</span>
										</div>
									</div>   
									<div class="d-flex align-items-center justify-content-between mb-3">
										<div class="d-flex align-items-center">
											...
											<a href="javascript:void(0);" class="border-start link-default fs-14 fw-normal ps-2 me-2 text-truncate d-inline-flex align-items-center"><img src="assets/img/users/user-03.jpg" class="avatar avatar-xs rounded-circle me-2 flex-shrink-0" alt="Img">Edward Marcus</a>
										</div>
										<div class="d-flex align-items-center">
										   <a href="#" class="p-1 d-flex align-items-center me-1" data-bs-toggle="modal" data-bs-target="#edit_blog"><i class="ti ti-edit"></i></a>
									...
									<h5>
										<a href="blog-details.html" class="fs-16 text-truncate">Best POS Systems for Retail Businesses</a>
									</h5>
								</div>
							</div>
						</div>
						<div class="col-xxl-4 col-md-6">
							<div class="card">
								<div class="card-body">
									<div class="img-sec w-100 position-relative mb-3">
										<a href="blog-details.html"><img src="assets/img/blogs/blog-03.jpg" class="img-fluid rounded w-100" alt="img"></a>
										<div>
											<a href="blog-details.html" class="trend-tag badge bg-soft-info shadow-none">Features</a>
											<span class="badge badge-success dot-icon"><i class="ti ti-point-filled"></i> Active</span>
										</div>
									</div>   
									<div class="d-flex align-items-center justify-content-between mb-3">
										<div class="d-flex align-items-center">
											...
											<a href="javascript:void(0);" class="border-start link-default fs-14 fw-normal ps-2 me-2 text-truncate d-inline-flex align-items-center"><img src="assets/img/users/user-05.jpg" class="avatar avatar-xs rounded-circle me-2 flex-shrink-0" alt="Img">Mark Phillips</a>
										</div>
										<div class="d-flex align-items-center">
										   <a href="#" class="p-1 d-flex align-items-center me-1" data-bs-toggle="modal" data-bs-target="#edit_blog"><i class="ti ti-edit"></i></a>
											 <a href="#" class="p-1 d-flex align-items-center" data-bs-toggle="modal" data-bs-target="#delete_modal"><i class="ti ti-trash"></i></a>
									...
									<h5>
										<a href="blog-details.html" class="fs-16 text-truncate">Key Features of a Modern POS</a>
									</h5>                        
								</div>
							</div>
						</div>
						<div class="col-xxl-4 col-md-6">
							<div class="card">
								<div class="card-body">
									<div class="img-sec w-100 position-relative mb-3">
										<a href="blog-details.html"><img src="assets/img/blogs/blog-04.jpg" class="img-fluid rounded w-100" alt="img"></a>
										<div>
											<a href="blog-details.html" class="trend-tag badge bg-soft-info shadow-none">Business</a>
											<span class="badge badge-success dot-icon"><i class="ti ti-point-filled"></i> Active</span>
										</div>
									...
									<div class="d-flex align-items-center justify-content-between mb-3">
										<div class="d-flex align-items-center">
											...
											<a href="javascript:void(0);" class="border-start link-default fs-14 fw-normal ps-2 me-2 text-truncate d-inline-flex align-items-center"><img src="assets/img/users/user-04.jpg" class="avatar avatar-xs rounded-circle me-2 flex-shrink-0" alt="Img">Nidia Hale</a>
										</div>
										<div class="d-flex align-items-center">
										   <a href="#" class="p-1 d-flex align-items-center me-1" data-bs-toggle="modal" data-bs-target="#edit_blog"><i class="ti ti-edit"></i></a>
											 <a href="#" class="p-1 d-flex align-items-center" data-bs-toggle="modal" data-bs-target="#delete_modal"><i class="ti ti-trash"></i></a>
									...
									<h5>
										<a href="blog-details.html" class="fs-16 text-truncate">Integrating POS with E-Commerce</a>
									</h5>                    
								</div>
							</div>
						</div>
						<div class="col-xxl-4 col-md-6">
							<div class="card">
								<div class="card-body">
									<div class="img-sec w-100 position-relative mb-3">
										<a href="blog-details.html"><img src="assets/img/blogs/blog-05.jpg" class="img-fluid rounded w-100" alt="img"></a>
										<div>
											<a href="blog-details.html" class="trend-tag badge bg-soft-info shadow-none">Features</a>
											<span class="badge badge-success dot-icon"><i class="ti ti-point-filled"></i> Active</span>
										</div>
									...
									<div class="d-flex align-items-center justify-content-between mb-3">
										<div class="d-flex align-items-center">
											...
											<a href="javascript:void(0);" class="border-start link-default fs-14 fw-normal ps-2 me-2 text-truncate d-inline-flex align-items-center"><img src="assets/img/users/user-06.jpg" class="avatar avatar-xs rounded-circle me-2 flex-shrink-0" alt="Img">Rebecca Dale</a>
										</div>
										<div class="d-flex align-items-center">
										   <a href="#" class="p-1 d-flex align-items-center me-1" data-bs-toggle="modal" data-bs-target="#edit_blog"><i class="ti ti-edit"></i></a>
											 <a href="#" class="p-1 d-flex align-items-center" data-bs-toggle="modal" data-bs-target="#delete_modal"><i class="ti ti-trash"></i></a>
									...
									<h5>
										<a href="blog-details.html" class="fs-16 text-truncate">AI & the Future of POS Systems</a>
									</h5>                        
								</div>
							</div>
						</div>
						<div class="col-xxl-4 col-md-6">
							<div class="card">
								<div class="card-body">
									<div class="img-sec w-100 position-relative mb-3">
										<a href="blog-details.html"><img src="assets/img/blogs/blog-06.jpg" class="img-fluid rounded w-100" alt="img"></a>
										<div>
											<a href="blog-details.html" class="trend-tag badge bg-soft-info shadow-none">Technology</a>
											<span class="badge badge-success dot-icon"><i class="ti ti-point-filled"></i> Active</span>
										</div>
									</div>   
									<div class="d-flex align-items-center justify-content-between mb-3">
										<div class="d-flex align-items-center">
											...
											<a href="javascript:void(0);" class="border-start link-default fs-14 fw-normal ps-2 me-2 text-truncate d-inline-flex align-items-center"><img src="assets/img/users/user-08.jpg" class="avatar avatar-xs rounded-circle me-2 flex-shrink-0" alt="Img">Jimmy Johnson</a>
										</div>
										<div class="d-flex align-items-center">
										   <a href="#" class="p-1 d-flex align-items-center me-1" data-bs-toggle="modal" data-bs-target="#edit_blog"><i class="ti ti-edit"></i></a>
											 <a href="#" class="p-1 d-flex align-items-center" data-bs-toggle="modal" data-bs-target="#delete_modal"><i class="ti ti-trash"></i></a>
									...
									<h5>
										<a href="blog-details.html" class="fs-16 text-truncate">Retail vs Restaurant POS: Key Differences</a>
									</h5>                       
								</div>
							</div>
						</div>
						<div class="col-xxl-4 col-md-6">
							<div class="card">
								<div class="card-body">
									<div class="img-sec w-100 position-relative mb-3">
										<a href="blog-details.html"><img src="assets/img/blogs/blog-07.jpg" class="img-fluid rounded w-100" alt="img"></a>
										<div>
											<a href="blog-details.html" class="trend-tag badge bg-soft-info shadow-none">Features</a>
											<span class="badge badge-success dot-icon"><i class="ti ti-point-filled"></i> Active</span>
										</div>
									...
									<div class="d-flex align-items-center justify-content-between mb-3">
										<div class="d-flex align-items-center">
											...
											<a href="javascript:void(0);" class="border-start link-default fs-14 fw-normal ps-2 me-2 text-truncate d-inline-flex align-items-center"><img src="assets/img/users/user-07.jpg" class="avatar avatar-xs rounded-circle me-2 flex-shrink-0" alt="Img">Stanley Pierre</a>
										</div>
										<div class="d-flex align-items-center">
										   <a href="#" class="p-1 d-flex align-items-center me-1" data-bs-toggle="modal" data-bs-target="#edit_blog"><i class="ti ti-edit"></i></a>
											 <a href="#" class="p-1 d-flex align-items-center" data-bs-toggle="modal" data-bs-target="#delete_modal"><i class="ti ti-trash"></i></a>
									...
									<h5>
										<a href="blog-details.html" class="fs-16 text-truncate">Understanding PCI Compliance for POS </a>
									</h5>                        
								</div>
							</div>
						</div>
						<div class="col-xxl-4 col-md-6">
							<div class="card">
								<div class="card-body">
									<div class="img-sec w-100 position-relative mb-3">
										<a href="blog-details.html"><img src="assets/img/blogs/blog-08.jpg" class="img-fluid rounded w-100" alt="img"></a>
										<div>
											<a href="blog-details.html" class="trend-tag badge bg-soft-info shadow-none">Technology</a>
											<span class="badge badge-success dot-icon"><i class="ti ti-point-filled"></i> Active</span>
										</div>
									...
									<div class="d-flex align-items-center justify-content-between mb-3">
										<div class="d-flex align-items-center">
											...
											<a href="javascript:void(0);" class="border-start link-default fs-14 fw-normal ps-2 me-2 text-truncate d-inline-flex align-items-center"><img src="assets/img/users/user-10.jpg" class="avatar avatar-xs rounded-circle me-2 flex-shrink-0" alt="Img">Alice Garcia</a>
										</div>
										<div class="d-flex align-items-center">
										   <a href="#" class="p-1 d-flex align-items-center me-1" data-bs-toggle="modal" data-bs-target="#edit_blog"><i class="ti ti-edit"></i></a>
											 <a href="#" class="p-1 d-flex align-items-center" data-bs-toggle="modal" data-bs-target="#delete_modal"><i class="ti ti-trash"></i></a>
									...
									<h5>
										<a href="blog-details.html" class="fs-16 text-truncate">Cloud vs On-Premise POS: Which is Better?</a>
									</h5>                      
								</div>
							</div>
						</div>
						<div class="col-xxl-4 col-md-6">
							<div class="card">
								<div class="card-body">
									<div class="img-sec w-100 position-relative mb-3">
										<a href="blog-details.html"><img src="assets/img/blogs/blog-09.jpg" class="img-fluid rounded w-100" alt="img"></a>
										<div>
											<a href="blog-details.html" class="trend-tag badge bg-soft-info shadow-none">Features</a>
											<span class="badge badge-success dot-icon"><i class="ti ti-point-filled"></i> Active</span>
										</div>
									...
									<div class="d-flex align-items-center justify-content-between mb-3">
										<div class="d-flex align-items-center">
											...
											<a href="javascript:void(0);" class="border-start link-default fs-14 fw-normal ps-2 me-2 text-truncate d-inline-flex align-items-center"><img src="assets/img/users/user-09.jpg" class="avatar avatar-xs rounded-circle me-2 flex-shrink-0" alt="Img">James Currier</a>
										</div>
										<div class="d-flex align-items-center">
										   <a href="#" class="p-1 d-flex align-items-center me-1" data-bs-toggle="modal" data-bs-target="#edit_blog"><i class="ti ti-edit"></i></a>
											 <a href="#" class="p-1 d-flex align-items-center" data-bs-toggle="modal" data-bs-target="#delete_modal"><i class="ti ti-trash"></i></a>
									...
									<h5>
										<a href="blog-details.html" class="fs-16 text-truncate">The Role of POS in Inventory Management</a>
									</h5>
								</div>
							</div>
						</div>
        ...
        <div class="modal fade" id="add_blog">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    ...
                    <form action="https://dreamspos.dreamstechnologies.com/html/template/all-blog.html">
                            ...
                            <div class="row">
										...
										<div class="profile-pic-upload">
											...
											<div class="mb-3">
												<div class="image-upload mb-0">
													...
													<p class="mb-0 mt-1 fs-13 no-wrap">Upload an image below 2 MB, Accepted File format JPG, PNG</p>
												</div>
											</div>
										</div>
									</div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3 ">
										...
										<input class="input-tags form-control" placeholder="Add new" type="text" data-role="tagsinput"  name="Label">
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="mb-3">
									...
									<div class="new-employee-field">
										<div class="profile-pic-upload">
											<div class="profile-pic edit-review people-profile-pic p-2 border rounded">                                                
												<img src="assets/img/blogs/blog-02.jpg" alt="Img">
				...
				<div class="modal-content">
					<div class="modal-body text-center">
						...
						<div class="d-flex justify-content-center">
							...
							<a href="cronjob-schedule.html" class="btn btn-primary">Yes, Delete</a>
						</div>
					</div>
				</div>
			</div>
		...
		<!-- jQuery -->
        <script src="assets/js/jquery-3.7.1.min.js" type="d71f021ab323125ad8bb097b-text/javascript"></script>
		
		<!-- Bootstrap Core JS -->
        <script src="assets/js/bootstrap.bundle.min.js" type="d71f021ab323125ad8bb097b-text/javascript"></script>

        <!-- Feather Icon JS -->
		<script src="assets/js/feather.min.js" type="d71f021ab323125ad8bb097b-text/javascript"></script>

		<!-- Slimscroll JS -->
		<script src="assets/js/jquery.slimscroll.min.js" type="d71f021ab323125ad8bb097b-text/javascript"></script>

		<!-- Select2 JS -->
		<script src="assets/plugins/select2/js/select2.min.js" type="d71f021ab323125ad8bb097b-text/javascript"></script>

		<!-- Summernote JS -->
		<script src="assets/plugins/summernote/summernote-bs4.min.js" type="d71f021ab323125ad8bb097b-text/javascript"></script>

		<!-- Bootstrap Tagsinput JS -->
		<script src="assets/plugins/bootstrap-tagsinput/bootstrap-tagsinput.js" type="d71f021ab323125ad8bb097b-text/javascript"></script>

		<!-- Color Picker JS -->
		<script src="assets/plugins/%40simonwep/pickr/pickr.es5.min.js" type="d71f021ab323125ad8bb097b-text/javascript"></script>

		<!-- Custom JS -->
		<script src="assets/js/theme-colorpicker.js" type="d71f021ab323125ad8bb097b-text/javascript"></script>
		<script src="assets/js/script.js" type="d71f021ab323125ad8bb097b-text/javascript"></script>

	
    <script src="../../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="d71f021ab323125ad8bb097b-|49" defer></script><script defer src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015" integrity="sha512-ZpsOmlRQV6y907TI0dKBHq9Md29nnaEIPlkf84rnaERnq6zvWvPUqr2ft8M1aS28oN72PdrCzSjY4U6VaAw1EQ==" data-cf-beacon='{"rayId":"93f784385ddbd059","version":"2025.4.0-1-g37f21b1","serverTiming":{"name":{"cfExtPri":true,"cfL4":true,"cfSpeedBrain":true,"cfCacheStatus":true}},"token":"3ca157e612a14eccbb30cf6db6691c29","b":1}' crossorigin="anonymous"></script>
</body>

<!-- Mirrored from dreamspos.dreamstechnologies.com/html/template/all-blog.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 May 2025 05:46:31 GMT -->
</html>