			...
			<div class="page-wrapper">
				<div class="content">
					<div class="page-header">
						...
						<div class="page-btn">
							<a href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add-warehouse"><i class="ti ti-circle-plus me-2"></i>Add Warehouse</a>
						</div>
					</div>
					<!-- /product list -->
					<div class="card">
								...
								<table class="table datatable">
									...
									<tbody>
										<tr>
											...
											<td>
												<div class="d-flex align-items-center">
													<a href="#" class="avatar avatar-md"><img src="{{ asset('assets/img/warehouse/avatar-01.png') }}" class="img-fluid rounded-2" alt="img"></a>
													<div class="ms-2">
										...
										<tr>
											...
											<td>
												<div class="d-flex align-items-center">
													<a href="#" class="avatar avatar-md"><img src="{{ asset('assets/img/warehouse/avatar-02.png') }}" class="img-fluid rounded-2" alt="img"></a>
													<div class="ms-2">
										...
										<tr>
											...
											<td>
												<div class="d-flex align-items-center">
													<a href="#" class="avatar avatar-md"><img src="{{ asset('assets/img/warehouse/avatar-03.png') }}" class="img-fluid rounded-2" alt="img"></a>
													<div class="ms-2">
										...
										<tr>
											...
											<td>
												<div class="d-flex align-items-center">
													<a href="#" class="avatar avatar-md"><img src="{{ asset('assets/img/warehouse/avatar-04.png') }}" class="img-fluid rounded-2" alt="img"></a>
													<div class="ms-2">
										...
										<tr>
											...
											<td>
												<div class="d-flex align-items-center">
													<a href="#" class="avatar avatar-md"><img src="{{ asset('assets/img/warehouse/avatar-05.png') }}" class="img-fluid rounded-2" alt="img"></a>
													<div class="ms-2">
										...
										<tr>
											...
											<td>
												<div class="d-flex align-items-center">
													<a href="#" class="avatar avatar-md"><img src="{{ asset('assets/img/warehouse/avatar-06.png') }}" class="img-fluid rounded-2" alt="img"></a>
													<div class="ms-2">
										...
										<tr>
											...
											<td>
												<div class="d-flex align-items-center">
													<a href="#" class="avatar avatar-md"><img src="{{ asset('assets/img/warehouse/avatar-07.png') }}" class="img-fluid rounded-2" alt="img"></a>
													<div class="ms-2">
										...
										<tr>
											...
											<td>
												<div class="d-flex align-items-center">
													<a href="#" class="avatar avatar-md"><img src="{{ asset('assets/img/warehouse/avatar-08.png') }}" class="img-fluid rounded-2" alt="img"></a>
													<div class="ms-2">
										...
										<tr>
											...
											<td>
												<div class="d-flex align-items-center">
													<a href="#" class="avatar avatar-md"><img src="{{ asset('assets/img/warehouse/avatar-09.png') }}" class="img-fluid rounded-2" alt="img"></a>
													<div class="ms-2">
										...
										<tr>
											...
											<td>
												<div class="d-flex align-items-center">
													<a href="#" class="avatar avatar-md"><img src="{{ asset('assets/img/warehouse/avatar-10.png') }}" class="img-fluid rounded-2" alt="img"></a>
													<div class="ms-2">
