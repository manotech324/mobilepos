                        ...
                        <li class="submenu-open">
                            ...
                            <ul>
                                ...
                                <li><a href="sub-categories.html"><i
                                            ...
                                            Category</span></a></li>
                                <li class="active"><a href="brand-list.html"><i
                    ...
                    <ul class="nav-menu">
                        ...
                        <li class="submenu">
                            <a href="javascript:void(0);" class="active subdrop"><i
                                    class="ti ti-brand-unity fs-16 me-2"></i><span> Inventory
                ...
                <div class="twocol-mini">
                    <div class="sidebar-left slimscroll">
                        <div class="nav flex-column align-items-center nav-pills" id="sidebar-tabs" role="tablist"
                            ...
                            <a href="#" class="nav-link active" title="Inventory" data-bs-toggle="tab"
                    ...
                    <ul class="table-top-head">
                        ...
                        <li>
                            <a data-bs-toggle="tooltip" data-bs-placement="top" title="Collapse"
                                id="collapse-header"><i class="ti ti-chevron-up"></i></a>
                        </li>
                    </ul>
                    <div class="page-btn">
                        <a href="#" class="btn btn-primary" data-bs-toggle="modal"
                            data-bs-target="#add-brand"><i class="ti ti-circle-plus me-1"></i>Add Brand</a>
                    </div>
                </div>
                <!-- /product list -->
                <div class="card">
                            ...
                            <table class="table datatable">
                                <thead class="thead-light">
                                    <tr>
                                        ...
                                        <th>Brand Name</th>
                                        <th>Created At</th>
                                        <th class="no-sort sorting" style="width: 124.05px;"></th>
                                    </tr>
                                </thead>
                                <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="action-table-data">
                                                <div class="edit-delete-action">
                                                    ...
                                                    {{-- Delete Form --}}
                                                    <form method="POST"
                                                        action="{{ route('supplier-brand.delete') }}"
                                                        id="delete-brand-{{ $brand->id }}">
                                                        @csrf
                                                        <input type="hidden" name="id"
                                                            value="{{ $brand->id }}">
                                                        <a onclick="setDeleteId({{ $brand->id }})" class="p-2"
                                                            href="javascript:void(0);" data-bs-toggle="modal"
    ...
    <div class="modal fade" id="add-brand">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="{{ route('supplier-brand.create') }}" method="POST">
                    @csrf
    ...
    <div class="modal fade" id="edit-brand">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form method="POST" id="edit-brand-form" action="">
					@csrf
					<div class="modal-body new-employee-field">
						<div class="mb-3">
							<label class="form-label">Brand<span class="text-danger ms-1">*</span></label>
							<input type="text" class="form-control @error('brand') is-invalid @enderror" id="brand-name" name="brand" value="{{ old('brand', '') }}">
							@error('brand')
                    ...
                    <div class="content p-5 px-3 text-center">
                        ...
                        <div class="modal-footer-btn mt-3 d-flex justify-content-center">
                            <button type="button"
                                ...
                                data-bs-dismiss="modal">Cancel</button>
                            <button onclick="deleteBrand()" type="button"
    ...
    <script>
        ...
        function deleteBrand() {
            if (currentDeleteId !== null) {
                const form = document.getElementById(`delete-brand-${currentDeleteId}`);
                if (form) {
                    form.submit();
                }
            }
...
<script>
    ...
    document.getElementById('edit-brand-form').action = `/dashboard/supplier-brand/update/${id}`;
}
