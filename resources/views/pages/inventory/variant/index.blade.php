...
@section('content')
		...
		<div class="modal fade" id="add-variant">
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					...
					<form action="https://dreamspos.dreamstechnologies.com/html/template/varriant-attributes.html">
		...
		<!-- Edit Unit -->
		<div class="modal fade" id="edit-variant">
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					<div class="modal-header">
						<div class="page-title">
					...
					<form action="https://dreamspos.dreamstechnologies.com/html/template/varriant-attributes.html">
						<div class="modal-body">
							...
							<div class="mb-3">
								<label class="form-label">Values<span class="text-danger ms-1">*</span></label>
								<input class="input-tags form-control" type="text" data-role="tagsinput" name="specialist" value="XS,S,M,L,XL">
								<span class="tag-text mt-2 d-flex">Enter value separated by comma</span>
							</div>
							<div class="mb-0 mt-3">
								<div class="status-toggle modal-status d-flex justify-content-between align-items-center">
				...
				<div class="modal-content">
					<div class="page-wrapper-new p-0">
						<div class="content p-5 px-3 text-center">
							...
							<p class="mb-0 fs-16">Are you sure you want to delete variant?</p>
