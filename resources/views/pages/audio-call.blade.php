...
<!-- Mirrored from dreamspos.dreamstechnologies.com/html/template/audio-call.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 May 2025 05:40:05 GMT -->
<head>
		...
		<script src="assets/js/theme-script.js" type="5b3a31a68c38c5b77f3dc379-text/javascript"></script>
    ...
    <body>
									...
									<ul>
										...
										<li class="submenu submenu-two"><a href="javascript:void(0);" class="active subdrop">Call<span class="menu-arrow inside-submenu"></span></a>
											<ul>
												...
												<li><a href="audio-call.html" class="active">Audio Call</a></li>
									...
									<div class="d-flex align-items-center justify-content-between">
										<div class="d-flex align-items-center">
											<span class="avatar avatar-lg avatar-rounded me-2">
												<img src="assets/img/users/user-27.jpg" class="img-fluid rounded-circle" alt="img">
											</span>
											<div>
		...
		<!-- jQuery -->
        <script src="assets/js/jquery-3.7.1.min.js" type="5b3a31a68c38c5b77f3dc379-text/javascript"></script>
		
		<!-- Bootstrap Core JS -->
        <script src="assets/js/bootstrap.bundle.min.js" type="5b3a31a68c38c5b77f3dc379-text/javascript"></script>

        <!-- Feather Icon JS -->
		<script src="assets/js/feather.min.js" type="5b3a31a68c38c5b77f3dc379-text/javascript"></script>

		<!-- Slimscroll JS -->
		<script src="assets/js/jquery.slimscroll.min.js" type="5b3a31a68c38c5b77f3dc379-text/javascript"></script>

		<!-- Datatable JS -->
		<script src="assets/js/jquery.dataTables.min.js" type="5b3a31a68c38c5b77f3dc379-text/javascript"></script>
		<script src="assets/js/dataTables.bootstrap5.min.js" type="5b3a31a68c38c5b77f3dc379-text/javascript"></script>

		<!-- Owl JS -->
		<script src="assets/plugins/owlcarousel/owl.carousel.min.js" type="5b3a31a68c38c5b77f3dc379-text/javascript"></script>

		<!-- Select2 JS -->
		<script src="assets/plugins/select2/js/select2.min.js" type="5b3a31a68c38c5b77f3dc379-text/javascript"></script>

		<!-- Sticky Sidebar JS -->
        <script src="assets/plugins/theia-sticky-sidebar/ResizeSensor.js" type="5b3a31a68c38c5b77f3dc379-text/javascript"></script>
        <script src="assets/plugins/theia-sticky-sidebar/theia-sticky-sidebar.js" type="5b3a31a68c38c5b77f3dc379-text/javascript"></script>

		<!-- Color Picker JS -->
		<script src="assets/plugins/%40simonwep/pickr/pickr.es5.min.js" type="5b3a31a68c38c5b77f3dc379-text/javascript"></script>

		<!-- Custom JS -->
		<script src="assets/js/theme-colorpicker.js" type="5b3a31a68c38c5b77f3dc379-text/javascript"></script>
		<script src="assets/js/script.js" type="5b3a31a68c38c5b77f3dc379-text/javascript"></script>
		
    <script src="../../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="5b3a31a68c38c5b77f3dc379-|49" defer></script><script defer src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015" integrity="sha512-ZpsOmlRQV6y907TI0dKBHq9Md29nnaEIPlkf84rnaERnq6zvWvPUqr2ft8M1aS28oN72PdrCzSjY4U6VaAw1EQ==" data-cf-beacon='{"rayId":"93f77fa24a769075","version":"2025.4.0-1-g37f21b1","serverTiming":{"name":{"cfExtPri":true,"cfL4":true,"cfSpeedBrain":true,"cfCacheStatus":true}},"token":"3ca157e612a14eccbb30cf6db6691c29","b":1}' crossorigin="anonymous"></script>
</body>
