...
<!-- Mirrored from dreamspos.dreamstechnologies.com/html/template/blog-categories.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 May 2025 05:46:32 GMT -->
<head>
		...
		<script src="assets/js/theme-script.js" type="80f8a7afc794702e3c0d62ce-text/javascript"></script>
    ...
    <body>
			...
			<div class="modal fade" id="add_blog-category">
				<div class="modal-dialog modal-dialog-centered modal-md">
					<div class="modal-content">
						...
						<form action="https://dreamspos.dreamstechnologies.com/html/template/blog-categories.html">
							...
							<div class="modal-footer">
								<button type="button" class="btn btn-secondary border me-2" data-bs-dismiss="modal">Cancel</button>
					...
					<div class="modal-content">
						<div class="modal-body text-center">
							...
							<div class="d-flex justify-content-center">
								...
								<a href="blog-categories.html" class="btn btn-primary">Yes, Delete</a>
							</div>
						</div>
					</div>
				</div>
		...
		<!-- jQuery -->
        <script src="assets/js/jquery-3.7.1.min.js" type="80f8a7afc794702e3c0d62ce-text/javascript"></script>
		
		<!-- Bootstrap Core JS -->
        <script src="assets/js/bootstrap.bundle.min.js" type="80f8a7afc794702e3c0d62ce-text/javascript"></script>

        <!-- Feather Icon JS -->
		<script src="assets/js/feather.min.js" type="80f8a7afc794702e3c0d62ce-text/javascript"></script>

		<!-- Slimscroll JS -->
		<script src="assets/js/jquery.slimscroll.min.js" type="80f8a7afc794702e3c0d62ce-text/javascript"></script>

		<!-- Datatable JS -->
		<script src="assets/js/jquery.dataTables.min.js" type="80f8a7afc794702e3c0d62ce-text/javascript"></script>
		<script src="assets/js/dataTables.bootstrap5.min.js" type="80f8a7afc794702e3c0d62ce-text/javascript"></script>

		<!-- Daterangepikcer JS -->
		<script src="assets/js/moment.min.js" type="80f8a7afc794702e3c0d62ce-text/javascript"></script>
		<script src="assets/plugins/daterangepicker/daterangepicker.js" type="80f8a7afc794702e3c0d62ce-text/javascript"></script>
		<script src="assets/js/bootstrap-datetimepicker.min.js" type="80f8a7afc794702e3c0d62ce-text/javascript"></script>

		<!-- Select2 JS -->
		<script src="assets/plugins/select2/js/select2.min.js" type="80f8a7afc794702e3c0d62ce-text/javascript"></script>

		<!-- Summernote JS -->
		<script src="assets/plugins/summernote/summernote-bs4.min.js" type="80f8a7afc794702e3c0d62ce-text/javascript"></script>

		<!-- Color Picker JS -->
		<script src="assets/plugins/%40simonwep/pickr/pickr.es5.min.js" type="80f8a7afc794702e3c0d62ce-text/javascript"></script>

		<!-- Custom JS -->
		<script src="assets/js/theme-colorpicker.js" type="80f8a7afc794702e3c0d62ce-text/javascript"></script>
		<script src="assets/js/script.js" type="80f8a7afc794702e3c0d62ce-text/javascript"></script>
	
    <script src="../../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="80f8a7afc794702e3c0d62ce-|49" defer></script><script defer src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015" integrity="sha512-ZpsOmlRQV6y907TI0dKBHq9Md29nnaEIPlkf84rnaERnq6zvWvPUqr2ft8M1aS28oN72PdrCzSjY4U6VaAw1EQ==" data-cf-beacon='{"rayId":"93f784643fcad059","version":"2025.4.0-1-g37f21b1","serverTiming":{"name":{"cfExtPri":true,"cfL4":true,"cfSpeedBrain":true,"cfCacheStatus":true}},"token":"3ca157e612a14eccbb30cf6db6691c29","b":1}' crossorigin="anonymous"></script>
</body>
