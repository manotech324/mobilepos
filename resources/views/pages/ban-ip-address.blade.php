...
<!-- Mirrored from dreamspos.dreamstechnologies.com/html/template/ban-ip-address.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 May 2025 05:48:08 GMT -->
<head>
		...
		<script src="assets/js/theme-script.js" type="c196d426ef0cb447bb2a2236-text/javascript"></script>
    ...
    <body>
						...
						<ul>
							...
							<li class="submenu-open">
								...
								<ul>
									...
									<li class="submenu">
										<a href="javascript:void(0);" class="active subdrop"><i class="ti ti-settings-2 fs-16 me-2"></i>
											<span>Other Settings</span><span class="menu-arrow"></span>
										</a>
										<ul>
											<li><a href="storage-settings.html">Storage</a></li>
											<li><a href="ban-ip-address.html" class="active">Ban IP Address</a></li>
										</ul>
									</li>
									<li>
				...
				<div id="sidebar-menu-3" class="sidebar-menu">
					<div class="main-menu">
						<ul class="nav-menu">
							...
							<li class="submenu">
								<a href="javascript:void(0);" class="active subdrop"><i class="ti ti-settings fs-16 me-2"></i><span>Settings</span><span class="menu-arrow"></span></a>
								<ul>
									<li class="submenu">
									...
									<li class="submenu">
										<a href="javascript:void(0);" class="active subdrop"><span>Other Settings</span><span class="menu-arrow"></span></a>
										<ul>
											<li><a href="storage-settings.html">Storage</a></li>
											<li><a href="ban-ip-address.html" class="active">Ban IP Address</a></li>
										</ul>
					...
					<div class="twocol-mini">
						<div class="sidebar-left slimscroll">
							<div class="nav flex-column align-items-center nav-pills" id="sidebar-tabs" role="tablist"
								...
								<a href="#" class="nav-link active" title="Settings" data-bs-toggle="tab" data-bs-target="#settings">
					...
					<div class="page-wrapper-new p-0">
						<div class="content">
							...
							<div class="modal-body">
								<form action="https://dreamspos.dreamstechnologies.com/html/template/ban-ip-address.html">
									<div class="row">
										<div class="col-lg-12">
											<div class="mb-3">
										...
										<div class="col-lg-12">
											<div class="form-group summer-description-box transfer">
							...
							<div class="modal-footer">
								...
								<button type="submit" class="btn btn-primary fs-13 fw-medium p-2 px-3">Add Ban IP Address</button>
							</div>
						</div>
					</div>
				</div>
								...
								<form action="https://dreamspos.dreamstechnologies.com/html/template/ban-ip-address.html">
									<div class="row">
										...
										<div class="col-lg-12">
											<div class="form-group summer-description-box transfer">
												<label class="form-label">Description</label>
												<div id="summernote3">Temporarily block to protect user accounts from internet fraudsters.</div>
												<p>Maximum 60 Characters</p>
											</div>
										</div>
									</div>
				...
				<div class="modal-content">
					<div class="page-wrapper-new p-0">
						<div class="content p-5 px-3 text-center">
								...
								<h4 class="fs-20 fw-bold mb-2 mt-1">Delete Ban IP Address</h4>
								<p class="mb-0 fs-16">Are you sure you want to delete ban IP address?</p>
		...
		<!-- jQuery -->
        <script src="assets/js/jquery-3.7.1.min.js" type="c196d426ef0cb447bb2a2236-text/javascript"></script>
		
		<!-- Bootstrap Core JS -->
        <script src="assets/js/bootstrap.bundle.min.js" type="c196d426ef0cb447bb2a2236-text/javascript"></script>

        <!-- Feather Icon JS -->
		<script src="assets/js/feather.min.js" type="c196d426ef0cb447bb2a2236-text/javascript"></script>

		<!-- Slimscroll JS -->
		<script src="assets/js/jquery.slimscroll.min.js" type="c196d426ef0cb447bb2a2236-text/javascript"></script>

		<!-- Datatable JS -->
		<script src="assets/js/jquery.dataTables.min.js" type="c196d426ef0cb447bb2a2236-text/javascript"></script>
		<script src="assets/js/dataTables.bootstrap5.min.js" type="c196d426ef0cb447bb2a2236-text/javascript"></script>
		
		<!-- Datetimepicker JS -->
		<script src="assets/js/moment.min.js" type="c196d426ef0cb447bb2a2236-text/javascript"></script>
		<script src="assets/js/bootstrap-datetimepicker.min.js" type="c196d426ef0cb447bb2a2236-text/javascript"></script>

		<!-- Summernote JS -->
		<script src="assets/plugins/summernote/summernote-bs4.min.js" type="c196d426ef0cb447bb2a2236-text/javascript"></script>

		<!-- Select2 JS -->
		<script src="assets/plugins/select2/js/select2.min.js" type="c196d426ef0cb447bb2a2236-text/javascript"></script>

		<!-- Sticky-sidebar -->
		<script src="assets/plugins/theia-sticky-sidebar/ResizeSensor.js" type="c196d426ef0cb447bb2a2236-text/javascript"></script>
		<script src="assets/plugins/theia-sticky-sidebar/theia-sticky-sidebar.js" type="c196d426ef0cb447bb2a2236-text/javascript"></script>

		<!-- Color Picker JS -->
		<script src="assets/plugins/%40simonwep/pickr/pickr.es5.min.js" type="c196d426ef0cb447bb2a2236-text/javascript"></script>

		<!-- Custom JS -->
		<script src="assets/js/theme-colorpicker.js" type="c196d426ef0cb447bb2a2236-text/javascript"></script>
		<script src="assets/js/script.js" type="c196d426ef0cb447bb2a2236-text/javascript"></script>
		
    <script src="../../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="c196d426ef0cb447bb2a2236-|49" defer></script><script defer src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015" integrity="sha512-ZpsOmlRQV6y907TI0dKBHq9Md29nnaEIPlkf84rnaERnq6zvWvPUqr2ft8M1aS28oN72PdrCzSjY4U6VaAw1EQ==" data-cf-beacon='{"rayId":"93f788c8df1ad059","version":"2025.4.0-1-g37f21b1","serverTiming":{"name":{"cfExtPri":true,"cfL4":true,"cfSpeedBrain":true,"cfCacheStatus":true}},"token":"3ca157e612a14eccbb30cf6db6691c29","b":1}' crossorigin="anonymous"></script>
</body>
