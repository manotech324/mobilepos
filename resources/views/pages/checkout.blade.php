...
<!-- Mirrored from dreamspos.dreamstechnologies.com/html/template/checkout.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 May 2025 05:42:06 GMT -->
<head>
		...
		<script src="assets/js/theme-script.js" type="43745a8c2576b2a78eaa774e-text/javascript"></script>
    ...
    <body>
					...
					<div class="row mb-3">
						<div class="col-md-7">
							<div class="card">
								...
								<div class="card-body">
									<form action="https://dreamspos.dreamstechnologies.com/html/template/checkout.html">
										<div class="row">
											<div class="col-md-6">
												<div class="mb-3">
		...
		<!-- jQuery -->
        <script src="assets/js/jquery-3.7.1.min.js" type="43745a8c2576b2a78eaa774e-text/javascript"></script>

        <!-- Feather Icon JS -->
		<script src="assets/js/feather.min.js" type="43745a8c2576b2a78eaa774e-text/javascript"></script>

		<!-- Slimscroll JS -->
		<script src="assets/js/jquery.slimscroll.min.js" type="43745a8c2576b2a78eaa774e-text/javascript"></script>

		<!-- Datatable JS -->
		<script src="assets/js/jquery.dataTables.min.js" type="43745a8c2576b2a78eaa774e-text/javascript"></script>
		<script src="assets/js/dataTables.bootstrap5.min.js" type="43745a8c2576b2a78eaa774e-text/javascript"></script>
		
		<!-- Bootstrap Core JS -->
        <script src="assets/js/bootstrap.bundle.min.js" type="43745a8c2576b2a78eaa774e-text/javascript"></script>
		
		<!-- Datetimepicker JS -->
		<script src="assets/js/moment.min.js" type="43745a8c2576b2a78eaa774e-text/javascript"></script>
		<script src="assets/js/bootstrap-datetimepicker.min.js" type="43745a8c2576b2a78eaa774e-text/javascript"></script>

		<!-- Summernote JS -->
		<script src="assets/plugins/summernote/summernote-bs4.min.js" type="43745a8c2576b2a78eaa774e-text/javascript"></script>

		<!-- Select2 JS -->
		<script src="assets/plugins/select2/js/select2.min.js" type="43745a8c2576b2a78eaa774e-text/javascript"></script>

		<!-- Color Picker JS -->
		<script src="assets/plugins/%40simonwep/pickr/pickr.es5.min.js" type="43745a8c2576b2a78eaa774e-text/javascript"></script>

		<!-- Custom JS -->
		<script src="assets/js/theme-colorpicker.js" type="43745a8c2576b2a78eaa774e-text/javascript"></script>
		<script src="assets/js/script.js" type="43745a8c2576b2a78eaa774e-text/javascript"></script>

	
    <script src="../../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="43745a8c2576b2a78eaa774e-|49" defer></script><script defer src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015" integrity="sha512-ZpsOmlRQV6y907TI0dKBHq9Md29nnaEIPlkf84rnaERnq6zvWvPUqr2ft8M1aS28oN72PdrCzSjY4U6VaAw1EQ==" data-cf-beacon='{"rayId":"93f780172ccbd059","version":"2025.4.0-1-g37f21b1","serverTiming":{"name":{"cfExtPri":true,"cfL4":true,"cfSpeedBrain":true,"cfCacheStatus":true}},"token":"3ca157e612a14eccbb30cf6db6691c29","b":1}' crossorigin="anonymous"></script>
</body>
