...
<!-- Mirrored from dreamspos.dreamstechnologies.com/html/template/chat.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 May 2025 05:36:44 GMT -->
<head>
		...
		<script src="assets/js/theme-script.js" type="a7ed888c36b3e6b8a76eea7f-text/javascript"></script>
    ...
    <body>
				...
				<div class="modern-profile p-3 pb-0">
					...
					<div class="sidebar-nav mb-3">
						<ul class="nav nav-tabs nav-tabs-solid nav-tabs-rounded nav-justified bg-transparent" role="tablist">
							<li class="nav-item"><a class="nav-link  border-0" href="#">Menu</a></li>
							<li class="nav-item"><a class="nav-link active border-0" href="chat.html">Chats</a></li>
						...
						<ul>
							<li class="submenu-open">
								...
								<ul>
									...
									<li class="submenu">
										<a href="javascript:void(0);" class="active subdrop"><i class="ti ti-brand-apple-arcade fs-16 me-2"></i><span>Application</span><span class="menu-arrow"></span></a>
										<ul>
							  ...
							  <div class="slimscroll">
								  ...
								  <div class="chat-search-header">                            
									  ...
									  <div class="search-wrap">
										  <form action="https://dreamspos.dreamstechnologies.com/html/template/chat.html">
								  ...
								  <div class="sidebar-body chat-body" id="chatsidebar">
									  ...
									  <div class="chat-users-wrap">
										  <div class="chat-list">
											  <a href="chat.html" class="chat-user-list">
												  <div class="avatar avatar-lg online me-2">
													  <img src="assets/img/avatar/avatar-14.jpg" class="rounded-circle" alt="image">
												  </div>
										  ...
										  <div class="chat-list"> 
											  <a href="chat.html" class="chat-user-list">
												  <div class="avatar avatar-lg online me-2">
													  <img src="assets/img/avatar/avatar-19.jpg" class="rounded-circle" alt="image">
												  </div>
												  <div class="chat-user-info">
													  <div class="chat-user-msg">
														  <h6>Elliot Murray</h6>
										  ...
										  <div class="chat-list">
											  <a href="chat.html" class="chat-user-list">
												  <div class="avatar avatar-lg online me-2">
													  <img src="assets/img/avatar/avatar-20.jpg" class="rounded-circle" alt="image">
												  </div>
												  <div class="chat-user-info">
													  <div class="chat-user-msg">
														  <h6>Rebecca Smtih</h6>
										  ...
										  <div class="chat-list">
											  <a href="chat.html" class="chat-user-list">
												  <div class="avatar avatar-lg online me-2">
													  <img src="assets/img/users/user-01.jpg" class="rounded-circle" alt="image">
												  </div>
												  <div class="chat-user-info">
													  <div class="chat-user-msg">
														  <h6>Harvey Smith</h6>
										  ...
										  <div class="chat-list">
											  <a href="chat.html" class="chat-user-list">
												  <div class="avatar avatar-lg online me-2">
													  <img src="assets/img/avatar/avatar-21.jpg" class="rounded-circle" alt="image">
												  </div>
												  <div class="chat-user-info">
													  <div class="chat-user-msg">
														  <h6>Lori Broaddus</h6>
										  ...
										  <div class="chat-list">
											  <a href="chat.html" class="chat-user-list">
												  <div class="avatar avatar-lg online me-2">
													  <img src="assets/img/users/user-09.jpg" class="rounded-circle" alt="image">
												  </div>
												  <div class="chat-user-info">
													  <div class="chat-user-msg">
										  ...
										  <div class="chat-list">
											<a href="chat.html" class="chat-user-list">
												<div class="avatar avatar-lg online me-2">
													<img src="assets/img/avatar/avatar-22.jpg" class="rounded-circle" alt="image">
												</div>
												<div class="chat-user-info">
													<div class="chat-user-msg">
													 <h6>Brian Villalobos</h6>
										...
										<div class="chat-list">
											<a href="chat.html" class="chat-user-list">
												<div class="avatar avatar-lg online me-2">
													<img src="assets/img/avatar/avatar-23.jpg" class="rounded-circle" alt="image">
												</div>
												<div class="chat-user-info">
													<div class="chat-user-msg">
										  ...
										  <div class="chat-list">
											  <a href="chat.html" class="chat-user-list">
												  <div class="avatar avatar-lg online me-2">
													  <img src="assets/img/avatar/avatar-24.jpg" class="rounded-circle" alt="image">
												  </div>
												  <div class="chat-user-info">
													  <div class="chat-user-msg">
														  <h6>Andrew Allen</h6>
								   ...
								   <div class="messages">
									   ...
									   <div class="chats chats-right">
										   ...
										   <div class="chat-avatar">
											   <img src="assets/img/users/user-49.png" class="rounded-circle dreams_chat" alt="image">
										   </div>
									   </div>     
									   <div class="chats">
										   <div class="chat-avatar">
		...
		<!-- jQuery -->
        <script src="assets/js/jquery-3.7.1.min.js" type="a7ed888c36b3e6b8a76eea7f-text/javascript"></script>

        <!-- Feather Icon JS -->
		<script src="assets/js/feather.min.js" type="a7ed888c36b3e6b8a76eea7f-text/javascript"></script>

		<!-- Slimscroll JS -->
		<script src="assets/js/jquery.slimscroll.min.js" type="a7ed888c36b3e6b8a76eea7f-text/javascript"></script>

		<!-- Datatable JS -->
		<script src="assets/js/jquery.dataTables.min.js" type="a7ed888c36b3e6b8a76eea7f-text/javascript"></script>
		<script src="assets/js/dataTables.bootstrap5.min.js" type="a7ed888c36b3e6b8a76eea7f-text/javascript"></script>
		
		<!-- Bootstrap Core JS -->
        <script src="assets/js/bootstrap.bundle.min.js" type="a7ed888c36b3e6b8a76eea7f-text/javascript"></script>
		
		<!-- Datetimepicker JS -->
		<script src="assets/js/moment.min.js" type="a7ed888c36b3e6b8a76eea7f-text/javascript"></script>
		<script src="assets/js/bootstrap-datetimepicker.min.js" type="a7ed888c36b3e6b8a76eea7f-text/javascript"></script>

		<!-- Summernote JS -->
		<script src="assets/plugins/summernote/summernote-bs4.min.js" type="a7ed888c36b3e6b8a76eea7f-text/javascript"></script>

		<!-- Mobile Input -->
		<script src="assets/plugins/intltelinput/js/intlTelInput.js" type="a7ed888c36b3e6b8a76eea7f-text/javascript"></script>

		<!-- Select2 JS -->
		<script src="assets/plugins/select2/js/select2.min.js" type="a7ed888c36b3e6b8a76eea7f-text/javascript"></script>
		
		<!-- Slimscroll JS -->
		<script src="assets/js/jquery.slimscroll.min.js" type="a7ed888c36b3e6b8a76eea7f-text/javascript"></script>

		<!-- Slimscroll JS -->
		<script src="assets/plugins/slimscroll/jquery.slimscroll.min.js" type="a7ed888c36b3e6b8a76eea7f-text/javascript"></script>
	
		<!-- Swiper JS -->
		<script src="assets/plugins/swiper/swiper.min.js" type="a7ed888c36b3e6b8a76eea7f-text/javascript"></script>
	
		<!-- FancyBox JS -->
		<script src="assets/plugins/fancybox/jquery.fancybox.min.js" type="a7ed888c36b3e6b8a76eea7f-text/javascript"></script>

		<!-- Color Picker JS -->
		<script src="assets/plugins/%40simonwep/pickr/pickr.es5.min.js" type="a7ed888c36b3e6b8a76eea7f-text/javascript"></script>

		<!-- Custom JS -->
		<script src="assets/js/theme-colorpicker.js" type="a7ed888c36b3e6b8a76eea7f-text/javascript"></script>
		<script src="assets/js/script.js" type="a7ed888c36b3e6b8a76eea7f-text/javascript"></script>
		
	
    <script src="../../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="a7ed888c36b3e6b8a76eea7f-|49" defer></script><script defer src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015" integrity="sha512-ZpsOmlRQV6y907TI0dKBHq9Md29nnaEIPlkf84rnaERnq6zvWvPUqr2ft8M1aS28oN72PdrCzSjY4U6VaAw1EQ==" data-cf-beacon='{"rayId":"93f77edcfe819075","version":"2025.4.0-1-g37f21b1","serverTiming":{"name":{"cfExtPri":true,"cfL4":true,"cfSpeedBrain":true,"cfCacheStatus":true}},"token":"3ca157e612a14eccbb30cf6db6691c29","b":1}' crossorigin="anonymous"></script>
</body>

<!-- Mirrored from dreamspos.dreamstechnologies.com/html/template/chat.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 May 2025 05:38:21 GMT -->
</html>